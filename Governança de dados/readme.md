...
Aborda as atividades de design, desenvolvimento e manutenção de data warehouses e sistemas de business intelligence, visando fornecer informações úteis e relevantes para suportar a tomada de decisões. Com base no que foi dito, o projeto utliza de um WorkSpace no azure data studio para possibilitar toda e qualquer proceso de DDL, DML necessarios para a gestão do banco de dados em SQL. Os recursos de armazenamento do azure disponibilizam a estrutura para fazer o controle de metricas de desempenho, como uso de GPU e CPU e os metodos de segurança. 

Ao decorrer do projeto, os metodos e tecnicas de ML serão aplicados nas bases de dados para analises preditivas, gerando informações e se tornando conhecimento para tomadas de decisão a curto, médio e longo prazo, podendo criar graficos e visuais no proprio notebook de python ou até mesmo nas plataformas Tableau e Power BI.
