...
/*-------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                          */
/*               INPUT_SAS_MICRODADOS_ENCCEJA_2018_QUESTIONARIO_PPL                	   */
/*-------------------------------------------------------------------------------------*/
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO QUESTIONÁRIO SOCIOECONÔMICO DO   */
/* ENCCEJA 2018 - PARTICIPANTES PPL NACIONAIS										   */
/*																					   */
/***************************************************************************************/
/***************************************************************************************/
/* Obs:                                                                                */
...
INFILE 'C:\QUESTIONARIO_ENCCEJA_PPL_NAC.csv' /*Endereço do arquivo em seu computador. Por exemplo: C:\arquivo.csv*/
        LRECL=169
		FIRSTOBS=2
        DLM=','
		MISSOVER
