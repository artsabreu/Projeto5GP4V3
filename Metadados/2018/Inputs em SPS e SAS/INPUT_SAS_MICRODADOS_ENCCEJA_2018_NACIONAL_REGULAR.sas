...
/*-------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                          */
/*               INPUT_SAS_MICRODADOS_ENCCEJA_2018_REGULAR_NACIONAL	                   */
/*-------------------------------------------------------------------------------------*/
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENCCEJA 2018- NACIONAL LIBERTOS  */
...
201847=	'Branca (Ensino Médio - Reaplicação)';
...
201846=	'Amarela (Ensino Médio - Reaplicação)';
...
201841=	'Rosa (Ensino Fundamental - Reaplicação)'
201845=	'Rosa (Ensino Médio - Reaplicação)';
...
201848=	'Azul (Ensino Médio - Reaplicação)';
...
INFILE 'C:\MICRODADOS_ENCCEJA_2018_REG_NAC.csv' /*Endereço do arquivo em seu computador. Por exemplo: C:\arquivo.csv*/
		LRECL=586
        FIRSTOBS=2
        DLM=','
        MISSOVER
...
Q34= ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Estudava no curso da empresa e foi interrompido'
Q35= ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Problemas de saúde ou acidentes comigo ou familiares'
Q36= ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Mudança de estado, município ou cidade'
Q37= ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Motivos pessoais: casamento / filhos'
Q38= ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Não tinha interesse / desisti'
Q39= ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Senti-me discriminado(a) / Sofri agressão (física ou verbal)'
Q40= ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Inexistência de vaga em escola pública'
Q41= ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Ausência de escola perto de casa'
Q42= ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Falta de interesse em estudar'
...
Q44= ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular:  Motivos pessoais - casamento / filhos'
Q45= ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Falta de apoio familiar'
Q46= ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Problemas de saúde ou acidente comigo ou familiares'
