...
/*-------------------------------------------------------------------------------------					     */
/*  PROGRAMA:                                                                                         			     */
/*               INPUT_SPSS_MICRODADOS_ENCCEJA_2018_PPL_NACIONAL 	                            	     */
/*-------------------------------------------------------------------------------------					     */
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENCCEJA 2018- PPL NACIONAL	     */
...
/* o arquivo "MICRODADOS_ENCCEJA_2018_PPL_NAC.csv" do ENCCEJA no diretório C:\ do computador.      	     */
/*							                                         */ 
...
GET DATA
  /TYPE=TXT
  /FILE="C:\MICRODADOS_ENCCEJA_2018_PPL_NAC.csv"
  /DELCASE=LINE
  /DELIMITERS=","
  /QUALIFIER='"'
...
CACHE.
EXECUTE.
DATASET NAME ENCCEJA_2018_PPL_NAC WINDOW=FRONT.
