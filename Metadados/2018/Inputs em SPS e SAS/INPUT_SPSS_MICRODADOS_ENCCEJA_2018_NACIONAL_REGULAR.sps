...
/*-------------------------------------------------------------------------------------					     */
/*  PROGRAMA:                                                                                         			     */
/*               INPUT_SPSS_MICRODADOS_ENCCEJA_2018_REGULAR_NACIONAL	                            	     */
/*-------------------------------------------------------------------------------------					     */
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENCCEJA 2018- REGULAR NACIONAL    */
...
/* o arquivo "MICRODADOS_ENCCEJA_2018_REG_NAC.csv" do ENCCEJA no diretório C:\ do computador.	     */
/*							                                         */ 
...
GET DATA 
  /TYPE=TXT 
  /FILE="C:\MICRODADOS_ENCCEJA_2018_REG_NAC.csv" 
  /DELCASE=LINE 
  /DELIMITERS="," 
  /QUALIFIER='"'
...
CACHE. 
EXECUTE.
DATASET NAME ENCCEJA_2018_REG_NAC WINDOW=FRONT.
...
201803	'Cinza (Ensino Fundamental)'
201807	'Cinza - Ledor (Ensino Fundamental)'
201811	'Branca (Ensino Médio)'
201815	'Branca - Ledor (Ensino Médio)'.
...
201802	'Amarela (Ensino Fundamental)'
201806	'Amarela - Ledor  (Ensino Fundamental)'
201810	'Amarela (Ensino Médio)'
201814	'Amarela - Ledor (Ensino Médio)'.
...
201801	'Rosa (Ensino Fundamental)'
201805	'Rosa - Ledor (Ensino Fundamental)'
201809	'Rosa (Ensino Médio)'
201813	'Rosa - Ledor (Ensino Médio)'.
...
201804	'Azul (Ensino Fundamental)'
201808	'Azul  - Ledor (Ensino Fundamental)'
201812	'Azul (Ensino Médio)'
201816	'Azul - Ledor (Ensino Médio)'.
...
'A'	'Sim'
'B'	'Não'.
VARIABLE LABELS Q34' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Estudava no curso da empresa e foi interrompido'.
VALUE LABELS Q34
'A'	'Sim'
'B'	'Não'.
VARIABLE LABELS Q35 ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Problemas de saúde ou acidentes comigo ou familiares'.
VALUE LABELS Q35
'A'	'Sim'
'B'	'Não'.
VARIABLE LABELS Q36 ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Mudança de estado, município ou cidade'.
VALUE LABELS Q36
'A'	'Sim'
'B'	'Não'.
VARIABLE LABELS Q37 ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Motivos pessoais: casamento / filhos'.
VALUE LABELS Q37
'A'	'Sim'
'B'	'Não'.
VARIABLE LABELS Q38 ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Não tinha interesse / desisti'.
VALUE LABELS Q38
'A'	'Sim'
'B'	'Não'.
VARIABLE LABELS Q39 ' Caso tenha deixado de cursar a EJA indique o(s) motivos(s)? Senti-me discriminado(a) / Sofri agressão (física ou verbal)'.
VALUE LABELS Q39
'A'	'Sim'
'B'	'Não'.
VARIABLE LABELS Q40 ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Inexistência de vaga em escola pública'.
VARIABLE LABELS Q41 ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Ausência de escola perto de casa'.
VARIABLE LABELS Q42 ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Falta de interesse em estudar'.
VARIABLE LABELS Q43 ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular:  Trabalho - falta de tempo para estudar'.
VARIABLE LABELS Q44 ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular:  Motivos pessoais - casamento / filhos'.
VARIABLE LABELS Q45 ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Falta de apoio familiar'.
VARIABLE LABELS Q46 ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Problemas de saúde ou acidente comigo ou familiares'.
VARIABLE LABELS Q47 ' Em que medida os motivos a seguir influenciaram no fato de você não ter frequentado ou ter abandonado a escola regular: Discriminação/preconceitos de raça, sexo, cor, idade ou socioeconômico'.
;
