...
/*-------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                          */
/*               INPUT_SAS_MICRODADOS_ENCCEJA_2019_PPL_NACIONAL	                       */
/*-------------------------------------------------------------------------------------*/
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENCCEJA 2019- NACIONAL PPL	   */
...
DATA ENCCEJA_PPL_NACIONAL;
 ...
 INFILE 'C:\MICRODADOS_ENCCEJA_NACIONAL_PPL_2019.csv' /*Endereço do arquivo em seu computador. Por exemplo: C:\arquivo.csv*/
        LRECL=476
		FIRSTOBS=2
        DLM=','
        MISSOVER
