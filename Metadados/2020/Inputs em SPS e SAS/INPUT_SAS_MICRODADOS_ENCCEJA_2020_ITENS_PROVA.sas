...
/*------------------------------------------------------------------------*/
/*  PROGRAMA:                                                             */
/*           INPUT_SAS_MICRODADOS_ENCCEJA_2020_ITENS_PROVA.sas	          */
/*------------------------------------------------------------------------*/
/*  DESCRICAO: PROGRAMA PARA LEITURA DOS ITENS DAS PROVAS DO ENCCEJA 2020 */    
/*                                                                        */
/**************************************************************************/
/**************************************************************************/
/* Obs:                                                                   */
...
/* MICRODADOS_ENCCEJA_ITENS_PROVA_2020.CSV no diretório C:\ do computador.*/
/*															 			  */                                           
...
DATA WORK.ITENS_PROVA_2020;
INFILE 'C:\MICRODADOS_ENCCEJA_ITENS_PROVA_2020.csv' /*Endereço do arquivo em seu computador. Por exemplo: C:\arquivo.csv*/
        LRECL=100
        FIRSTOBS=2
        DLM=','
        MISSOVER
