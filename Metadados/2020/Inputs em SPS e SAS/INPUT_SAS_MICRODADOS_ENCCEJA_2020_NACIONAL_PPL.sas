...
/*-------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                          */
/*               INPUT_SAS_MICRODADOS_ENCCEJA_2020_PPL_NACIONAL	                       */
/*-------------------------------------------------------------------------------------*/
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENCCEJA 2020- NACIONAL PPL	   */
...
VALUE CO_PROVA_LC
202019=	'Cinza (Ensino Fundamental)'
202023=	'Branca (Ensino Médio)';

VALUE CO_PROVA_MT
202018=	'Amarela (Ensino Fundamental)'
202022=	'Amarela (Ensino Médio)';

VALUE CO_PROVA_CN
202017=	'Rosa (Ensino Fundamental)'
202021=	'Rosa (Ensino Médio)';

VALUE CO_PROVA_CH
202020=	'Azul (Ensino Fundamental)'
202024=	'Azul (Ensino Médio)';
...
DATA ENCCEJA_2020_PPL_NACIONAL;

 INFILE 'C:\MICRODADOS_ENCCEJA_NACIONAL_PPL_2020.csv' /*Endereço do arquivo em seu computador. Por exemplo: C:\arquivo.csv*/
        LRECL=500
		FIRSTOBS=2
        DLM=','
        MISSOVER
