...
/*-------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                          */
/*               INPUT_SAS_MICRODADOS_ENCCEJA_2020_QUESTIONARIO_PPL                	   */
/*-------------------------------------------------------------------------------------*/
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO QUESTIONÁRIO SOCIOECONÔMICO DO   */
/* ENCCEJA 2020 - PARTICIPANTES PPL NACIONAIS										   */
/*																					   */
/***************************************************************************************/
/***************************************************************************************/
/* Obs:                                                                                */
...
/* arquivo "MICRODADOS_ENCCEJA_NACIONAL_PPL_QSE_2020.csv" do ENCCEJA no diretório C:\  */
/* do computador                                                                       */
/*							                                                           */ 
...
DATA ENCCEJA_2020_NAC_PPL_QSE;

INFILE 'C:\MICRODADOS_ENCCEJA_NACIONAL_PPL_QSE_2020.csv' /*Endereço do arquivo em seu computador. Por exemplo: C:\arquivo.csv*/
        LRECL=169
		FIRSTOBS=2
        DLM=','
		MISSOVER
...
ATTRIB	  Q021_1    FORMAT=1.;
ATTRIB	  Q021_2    FORMAT=1.;
ATTRIB	  Q021_3    FORMAT=1.;
ATTRIB	  Q021_4    FORMAT=1.;
ATTRIB	  Q021_5    FORMAT=1.;
ATTRIB	  Q022_1    FORMAT=1.;
ATTRIB	  Q022_2    FORMAT=1.;
ATTRIB	  Q022_3    FORMAT=1.;
ATTRIB	  Q022_4    FORMAT=1.;
ATTRIB	  Q022_5    FORMAT=1.;
...
ATTRIB	  Q030_1    FORMAT=1.;
ATTRIB	  Q030_2    FORMAT=1.;
ATTRIB	  Q030_3    FORMAT=1.;
ATTRIB	  Q030_4    FORMAT=1.;
ATTRIB	  Q030_5    FORMAT=1.;
ATTRIB	  Q030_6    FORMAT=1.;
ATTRIB	  Q030_7    FORMAT=1.;
ATTRIB	  Q030_8    FORMAT=1.;
