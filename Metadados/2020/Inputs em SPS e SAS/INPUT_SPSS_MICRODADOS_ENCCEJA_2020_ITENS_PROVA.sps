...
/*----------------------------------------------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                                                      */
/*           INPUT_SPSS_MICRODADOS_ENCCEJA_2020_ITENS_PROVA                   */
/*----------------------------------------------------------------------------------------------------------------------------*/
/*DESCRICAO: PROGRAMA PARA LEITURA DA BASE DE DADOS		*/
/* MICRODADOS_ENCCEJA_ITENS_PROVA_2020			*/
/*****************************************************************************************************/
/*****************************************************************************************************/
/* Obs:                                                                                                                    */
/* 		                                                                                           */
...
GET DATA
  /TYPE=TXT
  /FILE="C:\MICRODADOS_ENCCEJA_ITENS_PROVA_2020.csv" /*local do arquivo*/
  /DELCASE=LINE
  /DELIMITERS=","
...
CACHE.
EXECUTE.
DATASET NAME ITENS_PROVA_2020 WINDOW=FRONT.
...
VARIABLE LABELS	TP_LINGUA		"Língua Estrangeira".
VALUE LABELS TP_LINGUA
		0	'Inglês'
		1	'Espanhol'.
