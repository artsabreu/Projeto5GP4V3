...
/*-------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                          */
/*               INPUT_SAS_MICRODADOS_ENCCEJA_2022_NACIONAL_PPL	                       */
/*-------------------------------------------------------------------------------------*/
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENCCEJA 2022- NACIONAL PPL	   */
...
/* o arquivo com os dados MICRODADOS_ENCCEJA_2022_PPL_NAC.csv                          */
...
VALUE CO_PROVA_LC
202067=	'Cinza (Ensino Fundamental)'
202071=	'Branca (Ensino Médio)';

VALUE CO_PROVA_MT
202066=	'Amarela (Ensino Fundamental)'
202070=	'Amarela (Ensino Médio)';

VALUE CO_PROVA_CN
202065=	'Rosa (Ensino Fundamental)'
202069=	'Rosa (Ensino Médio)';

VALUE CO_PROVA_CH
202068=	'Azul (Ensino Fundamental)'
202072=	'Azul (Ensino Médio)';
...
DATA ENCCEJA_2022_PPL_NAC;

 INFILE 'C:\MICRODADOS_ENCCEJA_2022_PPL_NAC.csv' /*Endereço do arquivo em seu computador. Por exemplo: C:\arquivo.csv*/
        LRECL=500
		FIRSTOBS=2
        DLM=';'
        MISSOVER
...
ATTRIB	NU_NOTA_LC     FORMAT=3.;     
ATTRIB	NU_NOTA_MT     FORMAT=3.;     
ATTRIB	NU_NOTA_CN     FORMAT=3.;     
ATTRIB	NU_NOTA_CH     FORMAT=3.;     
...
IN_PROVA_LC= 'Indica solicitação de inscrição do participante na prova de: Língua Portuguesa, Língua Estrangeira Moderna, Artes, Educação Física e Redação (Cf. Dic.).'     
