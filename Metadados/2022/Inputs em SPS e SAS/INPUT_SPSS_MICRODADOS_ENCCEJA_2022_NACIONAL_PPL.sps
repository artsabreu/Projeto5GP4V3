...
/*-------------------------------------------------------------------------------------					     */
/*  PROGRAMA:                                                                                         			     */
/*               INPUT_SPSS_MICRODADOS_ENCCEJA_2022_NACIONAL_PPL 	                            	     */
/*-------------------------------------------------------------------------------------					     */
/* DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENCCEJA 2022- PPL NACIONAL	     */
...
/* o arquivo "MICRODADOS_ENCCEJA_2022_PPL_NAC.csv" do ENCCEJA no diretório C:\ do computador.      	     */
/*							                                         */ 
...
GET DATA
  /TYPE=TXT
  /FILE="C:\MICRODADOS_ENCCEJA_2022_PPL_NAC.csv"
  /DELCASE=LINE
  /DELIMITERS=";"
  /QUALIFIER='"'
...
CACHE.
EXECUTE.
DATASET NAME ENCCEJA_2022_NAC_PPL WINDOW=FRONT.
